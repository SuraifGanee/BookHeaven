...
namespace BookHeaven
{
    public partial class Customer : Form
    {
        ...
        private void Cus_Name_txtbox_TextChanged(object sender, EventArgs e)
        {
            mysavevalidate();
        }
        ...
        private void update_btn_Click(object sender, EventArgs e)
        {
            ...
            string Customer_Email = Email_txtbox.Text;
            string Customer_Address = Address_txtbox.Text;
            string sql = $"update Customer set name = '{Customer_Name}', email = '{Customer_Email}', address = '{Customer_Address}' where Customer_id = '{Cus_id_txtbox.Text}'";
            DbClass.update(sql);
            loadviewfunction();
        }
        ...
        {
            string sql = $"delete from Customer where Customer_ID = '{Cus_id_txtbox.Text}'";
            DbClass.delete(sql);
            loadviewfunction();
        }
        ...
        private void Customer_IDFK_Cbobox_SelectedIndexChanged(object sender, EventArgs e)
        {
            mysavevalidate1();
        }

        private void Cus_Mobiletxtbox_TextChanged(object sender, EventArgs e)
        {
            mysavevalidate1();
        }
        ...
        private void updatebtn2_Click(object sender, EventArgs e)
        {
            string Customer = Customer_IDFK_Cbobox.SelectedValue.ToString();
            string MobileNO = Cus_Mobiletxtbox.Text;
            string sql = $"update CustomerMobile set MobileNO = '{MobileNO}',CustomerID_FK  = '{Customer}' where CustomerMobile_id = '{MobileIDtxtbox.Text}'";
            DbClass.update(sql);
            loadviewfunction1();
        ...
        {
            string sql = $"delete from CustomerMobile where CustomerMobile_id = '{MobileIDtxtbox.Text}'";
            DbClass.delete(sql);
            loadviewfunction1();
        }
        ...
        private void Cus_Mob_Loadview_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
